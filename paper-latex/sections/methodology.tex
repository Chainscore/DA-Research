...
% Polkadot
\paragraph{Polkadot}
For benchmarking of Polkadot's ELVES we are using its Mainnet and Localnet. The current test code implements:
\begin{itemize}
...
\begin{table}[h!] \centering \caption{Comparative Throughput Analysis of DA Solutions} \label{tab:throughput} \setlength{\tabcolsep}{5pt} % reduce column padding 
    ...
    \begin{tabular}{|l|c|c|c|} \hline \textbf{Protocol} & \textbf{Max Throughput (MB/s)} \\ 
        \hline Polkadot & X \\ 
        Celestia & X \\ 
        Espresso & X \\ 
        NEAR & X \\ 
...
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{./figures/line-compare.png}
    \caption{\textbf{[DUMMY]} Comparative Throughput over time}
...
\begin{table}[h!] \centering \caption{Comparative TPS Analysis of DA Solutions} \label{tab:tps} \setlength{\tabcolsep}{5pt} % reduce column padding 
    \renewcommand{\arraystretch}{1.1} % tighten row spacing 
    \begin{tabular}{|l|c|c|c|} \hline \textbf{Protocol} & \textbf{Max TPS} \\ 
        \hline Polkadot & X \\ 
        Celestia & X \\ 
        Espresso & X \\ 
        NEAR & X \\ 
...
\paragraph{\textbf{Costing}}
Here we compare cost of storage across different sample sizes to analyze the increase in cost with demand.
\begin{figure}[h!]
    \centering
    \includegraphics[width=0.4\textwidth]{./figures/line-cost.png}
    \caption{\textbf{[DUMMY]} Comparative Cost over different data sizes}
    \label{fig:efficiency_boxplot}
\end{figure}
...
\begin{tabular}{|p{2cm}|p{3.5cm}|p{2cm}|p{2cm}|p{2cm}|}
\hline
\textbf{Network} &
\textbf{Honest Majority} &
\textbf{DA Sampling Size} &
...
\hline
\textbf{Celestia} &
$\geq \tfrac{2}{3}$ & $\geq 1$ honest full/light node for DA sampling &
100 & X \\
\hline
