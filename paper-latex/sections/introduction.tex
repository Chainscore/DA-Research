...
\footnotesize
\begin{tabular}{|p{1.4cm}|p{1.4cm}|p{1.5cm}|p{1.5cm}|p{1.2cm}|p{1.2cm}|}
\hline
\textbf{Feature} &
\makecell[l]{\textbf{Polkadot's}\\\textbf{ELVES}} &
\textbf{Celestia} &
...
\hline
Consensus & BABE/
GRANDPA & Tendermint & HotShot & Night\-shade & --- \\
\hline
Storage & Sharding & Reed-Solomon & Three-layer & Sharding & KZG \\
\hline
Block Time & 20s & 15s & \textasciitilde6s & 1s & 20s \\
\hline
Validation & Light Client & Light Client & Full Node & Chunk-only & Light Client \\
\hline
\end{tabular}
